...
# !!! Main.UserApp is configured as an alias for Main.Geniedemo and you might encounter it in some tests
using Main.Geniedemo, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Geniedemo tests" begin
  @includetests ARGS
end
